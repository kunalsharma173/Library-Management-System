...
class maincode:
     ...
     def login(self):
         ...
         if self.ab!=None:
             ...
             self.under_fm=Frame(root,height=500,width=900,bg='#F2BC94') #name
             self.under_fm.place(x=0,y=0)
             self.fm2=Frame(root,bg='#00154F',height=80,width=900)
             self.fm2.place(x=0,y=0)

             #  lgo=Canvas(fm2,bg='#4d61a3',height=200,width=100,bd=4,relief='flat')
             #  lgo.place(x=0,y=0)

             self.lbb=Label(self.fm2,bg='#F2BC94') #icon color
             self.lbb.place(x=15,y=5)
             self.ig=PhotoImage(file=r"C:\Users\Kunal Sharma\Desktop\PYTHON PROJECTS\Library management System GUI\Library management System GUI\images (1) (1).png")
             self.lbb.config(image=self.ig)
             self.lb3=Label(self.fm2,text='DASHBOARD',fg='#F4AF1B',bg='#00154F',font=('Arial',30,'bold'))
             self.lb3.place(x=325,y=17)


             #----------------------------name------------------------

             self.name=Label(root,text="Name : ",bg='#F2BC94',fg="black",font=('Arial',10,'bold'))
             self.name.place(x=5,y=83)
             self.name1=Label(root,text=self.ab[1],fg='black',bg='#F2BC94',font=('Arial',10,'bold'))
             self.name1.place(x=60,y=83)

             #------------------------date-------------------------

             self.today=date.today()
             self.dat=Label(root,text='Date : ',bg='#F2BC94',fg='black',font=('Arial',10,'bold'))
             self.dat.place(x=740,y=83)
             self.dat2 = Label(root, text=self.today, bg='#F2BC94', fg='black', font=('Arial', 10, 'bold'))
             ...
             #---------------------------------------------------------
     def cur(self):
             self.fm3=Frame(root,bg='#F2BC94',width=900,height=390)
             ...
             self.lb1_hr = Label(self.fm3, text='12', font=('times new roman', 20, 'bold'), bg='#F4AF1B', fg='white')
             self.lb1_hr.place(x=560, y=0, width=60, height=30)


             self.lb3_hr = Label(self.fm3, text='05', font=('times new roman', 20, 'bold'), bg='#F4AF1B', fg='white')
             self.lb3_hr.place(x=630, y=0, width=60, height=30)


             self.lb5_hr = Label(self.fm3, text='37', font=('times new roman', 20, 'bold'), bg='#00154F', fg='white')
             self.lb5_hr.place(x=700, y=0, width=60, height=30)


             self.lb7_hr = Label(self.fm3, text='AM', font=('times new roman', 17, 'bold'), bg='#00154F', fg='white')
             ...
             self.photo9=PhotoImage(file=r"C:\Users\Kunal Sharma\Desktop\PYTHON PROJECTS\Library management System GUI\Library management System GUI\bb.png")
             self.canvas8.create_image(0,0,image=self.photo9,anchor=NW)

     
             #-----------------addbutton-----------------

             self.bt1=Button(self.fm3,text='  Add Books',fg='#00154F',bg='#F2BC94',font=('Arial',15,'bold'),width=170,
             ...
             self.bt2 = Button(self.fm3, text='  Issue Books', fg='#00154F', bg='#F2BC94', font=('Arial', 15, 'bold'),
             ...
             self.bt3 = Button(self.fm3, text='  Edit Books', fg='#00154F', bg='#F2BC94', font=('Arial', 15, 'bold'),
             ...
             self.bt4 = Button(self.fm3, text='  Return Books', fg='#00154F', bg='#F2BC94', font=('Arial', 15, 'bold'),
             ...
             self.bt5 = Button(self.fm3, text=' Delete Books', fg='#00154F', bg='#F2BC94', font=('Arial', 15, 'bold'),
             ...
             self.bt6 = Button(self.fm3, text='  Show Books', fg='#00154F', bg='#F2BC94', font=('Arial', 15, 'bold'),
             ...
             self.bt7 = Button(self.fm3, text=' Search Books', fg='#00154F', bg='#F2BC94', font=('Arial', 15, 'bold'),
             ...
             try:
                ...
                self.bt8 = Button(self.fm3, text='  log Out', fg='#00154F', bg='#F2BC94', font=('Arial', 15, 'bold'),
                               width=170,
    ...
    #-----------------------button add book----------------------
     ...
     def addbook(self):
         class temp(maincode):
             ...
             def book(self):
                 ...
                 self.fm=Frame(root,bg='#F2BC94',width=900,height=390)
                 self.fm.place(x=0,y=110)
                 self.fm1=Frame(self.fm,bg='#F4AF1B',width=500,height=360,bd=5,relief='flat')
                 self.fm1.place(x=200,y=15)
                 self.backbt = Button(self.fm, width=60, bg='#F2BC94',activebackground='#F2BC94', bd=0, relief='flat',\
                                                                                                 command=self.cur)
                 ...
                 #---------------------------Label---------------------------------
                 self.f=Frame(self.fm1,bg='#00154F',width=490,height=35)
                 self.f.place(x=0,y=0)
                 self.ll=Label(self.f,text='ADD BOOKS',fg='#F4AF1B',bg='#00154F',font=('Arial',12,'bold'))
                 self.ll.place(x=200,y=6)
                 self.lb=Label(self.fm1,text='ID',fg='#00154F',bg='#F4AF1B',font=('Arial',10,'bold'))
                 self.lb.place(x=70,y=90)
                 self.lb2 = Label(self.fm1, text='Title', fg='#00154F', bg='#F4AF1B', font=('Arial', 10, 'bold'))
                 self.lb2.place(x=70, y=130)
                 self.lb3 = Label(self.fm1, text='Author', fg='#00154F', bg='#F4AF1B', font=('Arial', 10, 'bold'))
                 self.lb3.place(x=70, y=170)
                 self.lb4= Label(self.fm1, text='Edition', fg='#00154F', bg='#F4AF1B', font=('Arial', 10, 'bold'))
                 self.lb4.place(x=70, y=210)
                 self.lb5 = Label(self.fm1, text='Price', fg='#00154F', bg='#F4AF1B', font=('Arial', 10, 'bold'))
                 ...
                 self.bt=Button(self.fm1,text='Submit',width=41,bg='#00154F',fg='#F4AF1B',font=('Arial',10,'bold'),bd=5,
     ...
     def issuebook(self):
         class test(maincode):
              ...
              n = 1
              def issue(self):
                  self.f = Frame(root, bg='#F2BC94', width=900, height=390)
                  self.f.place(x=0, y=110)

                  self.fmi=Canvas(self.f,bg='#F2BC94',width=900,height=390,bd=0,relief='flat')
                  self.fmi.place(x=0,y=0)
                  #self.img=PhotoImage(file='ig.png')
                  #self.fmi.create_image(0,0,image=self.img,anchor=NW)

                  self.fc=Frame(self.fmi,bg='#F2BC94',width=330,height=230,bd=4,relief='flat')
                  self.fc.place(x=70,y=20)

                  self.ffb=Frame(self.fc,bg='#F2BC94',bd=2,relief='flat',width=330,height=35)
                  self.ffb.place(x=0,y=0)

                  self.lc=Label(self.ffb,text='STUDENT  INFORMATION',bg='#00154F',fg='#F4AF1B',font=('Arial',12,'bold'))
                  self.lc.place(x=55,y=5)

                  self.lb=Label(self.fc,text='Roll-No',bg='#00154F',fg='#F4AF1B',font=('Arial',10,'bold'))
                  self.lb.place(x=15,y=60)
                  self.ob=Label(self.fc,text='or',bg='#00154F',fg='#F4AF1B',font=('cursive',12,'bold'))
                  self.ob.place(x=180,y=90)
                  self.em = Entry(self.fc, width=30, bd=5, relief='ridge', font=('Arial', 8, 'bold'))
                  self.em.place(x=105, y=60)
                  self.lb = Label(self.fc, text='USN', bg='#00154F', fg='#F4AF1B', font=('Arial', 10, 'bold'))
                  self.lb.place(x=15, y=120)
                  self.em2 = Entry(self.fc, width=30, bd=5, relief='ridge', font=('Arial', 8, 'bold'))
                  self.em2.place(x=105, y=120)
                  self.bt = Button(self.fc, text='Submit', width=14, bg='#00154F', fg='#F4AF1B', font=('Arial', 10, 'bold'),
                                 bd=5,relief='flat',command=self.check)
                  self.bt.place(x=15,y=180)

                  self.bt3=Button(self.fc,text='Clear',width=14,bg='#00154F',fg='#F4AF1B',font=('arial',10,'bold'),bd=5,
                            relief='flat',command=self.clr)
                  self.bt3.place(x=165,y=180)

                  self.backbt = Button(self.fmi,width=60, bg='#F2BC94',activebackground='#F2BC94',bd=0, relief='flat',
                                       command=self.cur)
              ...
              def check(self):
                  ...
                  if self.var!=None:
                        self.lb1=Label(self.fmi,text='Name :',fg='#F4AF1B',bg='#00154F',font=('Arial',10,'bold'))
                        self.lb1.place(x=60,y=255)
                        self.lb2 = Label(self.fmi, text=self.var[1], fg='#F4AF1B',bg='#00154F', font=('Arial', 10, 'bold'))
                        self.lb2.place(x=130, y=255)
                        self.lb3 = Label(self.fmi, text='Course :',fg='#F4AF1B',bg='#00154F', font=('Arial', 10, 'bold'))
                        self.lb3.place(x=60, y=275)
                        self.lb4 = Label(self.fmi, text=self.var[2],fg='#F4AF1B',bg='#00154F', font=('Arial', 10, 'bold'))
                        self.lb4.place(x=130, y=275)
                        self.lb5 = Label(self.fmi, text='Year :', fg='#F4AF1B',bg='#00154F', font=('Arial', 10, 'bold'))
                        self.lb5.place(x=60, y=295)
                        self.lb6 = Label(self.fmi, text=self.var[3], fg='#F4AF1B',bg='#00154F', font=('Arial', 10, 'bold'))
                        self.lb6.place(x=130, y=295)
                        self.lb7 = Label(self.fmi, text='Contact :', fg='#F4AF1B',bg='#00154F', font=('Arial', 10, 'bold'))
                        self.lb7.place(x=60, y=315)
                        self.lb8 = Label(self.fmi, text=self.var[6],fg='#F4AF1B',bg='#00154F', font=('Arial', 10, 'bold'))
                        self.lb8.place(x=130, y=315)
                        self.lb9 = Label(self.fmi, text='College :', fg='#F4AF1B',bg='#00154F', font=('Arial', 10, 'bold'))
                        self.lb9.place(x=60, y=335)
                        self.lb10 = Label(self.fmi, text=self.var[7],fg='#F4AF1B',bg='#00154F', font=('Arial', 10, 'bold'))
                        self.lb10.place(x=130, y=335)


                        self.fr=Frame(self.fmi,bg='#00154F',bd=5,relief='flat',width=450,height=320)
                        self.fr.place(x=420,y=20)
                        self.ff=Frame(self.fr,bg='#0f624c',bd=2,relief='flat',width=450,height=35)
                        self.ff.place(x=0,y=0)
                        self.lb=Label(self.ff,text='ISSUE BOOK',bg='#0f624c',fg='#F4AF1B',font=('Arial',12,'bold'))
                        self.lb.place(x=165,y=5)
                        self.tt=Label(self.fr,text='Book-ID',bg='#F4AF1B',fg='black',font=('arial',10,'bold'))
                        self.tt.place(x=50,y=60)
                        self.e1 = Entry(self.fr, width=30, bd=5, relief='ridge', font=('Arial', 8, 'bold'))
                        self.e1.place(x=160, y=60)
                        self.ttp = Label(self.fr, text='Title', bg='#F4AF1B', fg='black', font=('arial', 10, 'bold'))
                        self.ttp.place(x=50, y=110)
                        self.e2 = Entry(self.fr, width=30, bd=5, relief='ridge', font=('Arial', 8, 'bold'))
                        self.e2.place(x=160, y=110)
                        self.bt1 = Button(self.fr, text='Submit', width=35, bg='#0f624c', fg='#F4AF1B', font=('Arial', 10,
              ...
              def mail(self):
                    ...
                    cursor=dc.cursor()
                    cursor.execute("SELECT * FROM student WHERE USN='"+self.baby+"'")
                    self.var=cursor.fetchone()
                    ...
                    message = """FROM: LIBRARY DEPARTMENT
                              ...
                              Subject: Hello Student! Your book has benn Issued"""
                    try:
     ...
     def edit(self):
         class editing(maincode):
               def edbooks(self):
                     ...
                     self.ffm=Frame(root,bg='#F2BC94',width=900,height=390)
                     self.ffm.place(x=0,y=110)
                     self.fm1 = Frame(self.ffm, bg='#F4AF1B', width=500, height=200, bd=5, relief='flat')
                     self.fm1.place(x=200, y=15)
                     self.ed = Frame(self.fm1, bg='#00154F', bd=0, relief='flat', width=490, height=35)
                     self.ed.place(x=0,y=0)
                     self.lab = Label(self.ed, text='EDIT BOOKS DETAILS', bg='#00154F', fg='#F4AF1B', font=('Arial', 12,
                                                                                                    'bold'))
                     self.lab.place(x=165, y=5)
                     self.label3=Label(self.fm1,text='Book ID',bg='#F4AF1B',fg='black',font=('arial',10,'bold'))
                     ...
                     self.button7 = Button(self.fm1, text='Search', bg='#00154F', fg='#F4AF1B', width=24, height=0,
                                  font=('Arial', 10, 'bold'),command=self.search)
                     self.button7.place(x=140,y=120)

                     self.backbt = Button(self.ffm, width=60, bg='#F2BC94',activebackground='#F2BC94',
     ...
     def return_book(self):
         class retu(maincode):
             ...
             def __init__(self):
                 self.frame=Frame(root,bd=0,relief='flat',bg='#F2BC94',width=900,height=390)
                 self.frame.place(x=0,y=110)
                 self.f1 = Frame(self.frame, bg='#F4AF1B' , width=500, height=200, bd=5, relief='flat')
                 self.f1.place(x=200, y=15)
                 self.ed = Frame(self.f1, bg='#00154F', bd=0, relief='flat', width=490, height=35)
                 self.ed.place(x=0, y=0)
                 self.lac = Label(self.ed, text='RETURN BOOKS ', bg='#00154F', fg='#F4AF1B', font=('Arial', 12, 'bold'))
                 self.lac.place(x=175, y=5)
                 self.label8 = Label(self.f1, text='USN', bg='#F4AF1B', fg='black', font=('arial', 10, 'bold'))
                 ...
                 self.button9 = Button(self.f1, text='Return', bg='#00154F', fg='#F4AF1B', width=24, height=0,
                                       font=('Arial', 10, 'bold'),command=self.retbook)
                 self.button9.place(x=140, y=120)

                 self.backbt = Button(self.frame, width=60, bg='#F2BC94', activebackground='#F2BC94',
                                      bd=0, relief='flat', command=self.cur)
                 self.backbt.place(x=0, y=0)
                 self.log = PhotoImage(file='back.png')
                 self.backbt.config(image=self.log, compound=LEFT)
             ...
             def retbook(self):
                 ...
                 #-----------------between two date calculate days---------------------
                     ...
                     messagebox.showwarning("Library System","YOUR USN IS NOT FOUND !")
     ...
     def delete(self):
         class dele(maincode):
               def deleteee(self):
                     self.ff = Frame(root, bg='#F2BC94', width=900, height=390)
                     self.ff.place(x=0, y=110)
                     self.f1 = Frame(self.ff, bg='#F4AF1B', width=500, height=200, bd=5, relief='flat')
                     self.f1.place(x=200, y=15)
                     self.ed = Frame(self.f1, bg='#F4AF1B', bd=0, relief='flat', width=490, height=35)
                     self.ed.place(x=0, y=0)
                     self.lac = Label(self.ed, text='DELETE BOOKS ', bg='#00154F', fg='#F4AF1B', font=('Arial', 12,'bold'))
                     self.lac.place(x=175, y=5)
                     self.label8 = Label(self.f1, text='Book ID', bg='#F4AF1B', fg='black', font=('arial', 10, 'bold'))
                     self.label8.place(x=85, y=65)
                     self.entry4 = Entry(self.f1, width=30, bd=4, relief='groove', font=('arial', 8, 'bold'))
                     self.entry4.place(x=188, y=65)
                     self.button9 = Button(self.f1, text='Delete', bg='#00154F', fg='#F4AF1B', width=24, height=0,
                                  font=('Arial', 10, 'bold'),command=self.deldata)
                     self.button9.place(x=140, y=120)

                     self.backbt = Button(self.ff,width=60, bg='#F2BC94',activebackground='#F2BC94',
                                          bd=0, relief='flat', command=self.cur)
                     self.backbt.place(x=0, y=0)
                     self.log = PhotoImage(file='back.png')
                     self.backbt.config(image=self.log, compound=LEFT)
     ...
     def search(self):
         class demt(maincode):
             def delmdata(self):
                 ...
                 self.fc = Frame(root, bg='#F2BC94', width=900, height=390)
                 self.fc.place(x=0, y=110)
                 self.fc1 = Frame(self.fc, bg='#F4AF1B', width=500, height=200, bd=5, relief='flat')
                 self.fc1.place(x=200, y=15)
                 self.edm = Frame(self.fc1, bg='#00154F', bd=0, relief='flat', width=490, height=35)
                 self.edm.place(x=0, y=0)
                 self.lac = Label(self.edm, text='SEARCH BOOKS ', bg='#00154F', fg='#F4AF1B', font=('Arial', 12, 'bold'))
                 self.lac.place(x=175, y=5)
                 self.label8 = Label(self.fc1, text='Book ID', bg='#F4AF1B', fg='black', font=('arial', 10, 'bold'))
                 self.label8.place(x=85, y=65)
                 self.entryl= Entry(self.fc1, width=30, bd=4, relief='groove', font=('arial', 8, 'bold'))
                 self.entryl.place(x=188, y=65)
                 self.butto = Button(self.fc1, text='Search', bg='#00154F', fg='#F4AF1B', width=24, height=0,
                                       font=('Arial', 10, 'bold'),command=self.srch)
                 self.butto.place(x=140, y=120)

                 self.backbt = Button(self.fc,width=60, bg='#F2BC94',activebackground='#F2BC94',bd=0, relief='flat', command=self.cur)
                 self.backbt.place(x=0, y=0)
                 self.log = PhotoImage(file='back.png')
                 self.backbt.config(image=self.log, compound=LEFT)
                 self.small_log = self.log.subsample(1, 1)
    ...
    #-------------------------------------------SHOW BOOKS_------------------------------------------------
     ...
     def show(self):
         class tst(maincode):
             def __init__(self):
                 self.fc = Frame(root, bg='#F2BC94', width=900, height=390)
                 self.fc.place(x=0, y=110)
                 self.popframe=Frame(self.fc,width=900,height=30,bg='#F2BC94')
                 self.popframe.place(x=0,y=0)
                 self.lbn=Label(self.popframe,bg='#00154F',text='BOOKS INFORMATION',fg='#F4AF1B',font=('arial',10,
                                                                                                      'bold'))
                 self.lbn.place(x=380,y=5)

                 self.backbt = Button(self.popframe,width=30, bg='#F2BC94',activebackground='#F2BC94',
                                      bd=0, relief='flat', command=self.cur)
                 self.backbt.place(x=0, y=0)
                 self.log = PhotoImage(file='back.png')
                 self.backbt.config(image=self.log, compound=LEFT)
                 ...
                 self.table_frame=Frame(self.fc,bg='#F4AF1B',bd=1,relief='flat')
     ...
     def code(self):
         ...
         self.photo=PhotoImage(file=r"C:\Users\Kunal Sharma\Desktop\PYTHON PROJECTS\Library management System GUI\Library management System GUI\bb.png")
         self.canvas.create_image(70,45,image=self.photo,anchor=NW)

         self.fm1=Frame(self.canvas,height=260,width=300,bg='#05547d',bd=3,relief='ridge')
         self.fm1.place(x=300,y=170)

         self.photo1=PhotoImage(file=r"C:\Users\Kunal Sharma\Desktop\PYTHON PROJECTS\Library management System GUI\Library management System GUI\bb.png")
         ...
         self.btn1=Button(self.fm1,text='  login',fg='white',bg='#F0810F',width=100,font=('Arial',11,'bold'),
         ...
         self.btn2=Button(self.fm1,text='  Clear',fg='white',bg='#E6DF44',width=100,font=('Arial',11,'bold'),
